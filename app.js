...
function resolveEmailDisplay(item) {
  if (!item) return "—";
  if (item.wa && item.wa.includes("@")) return item.wa.trim();
  ...
  if (pengaju) {
    ...
    try {
      const data = JSON.parse(localStorage.getItem("spms_profile_" + roleClean) || "{}");
      if (data && data.email) return data.email.trim();
    } catch(e) {}
  ...
  try {
    const savedProf = getSavedProfile();
    if (savedProf && savedProf.email) return savedProf.email.trim();
  } catch(e) {}
...
function renderAdminPurchasesTable() {
  ...
  tbody.innerHTML = filtered.map((i, idx) => `
    <tr>
      ...
      <td>
        <div style="display:flex; gap:8px; align-items:center;">
          <div style="text-align:center;"><div style="font-size:9px;color:#64748b;font-weight:600;margin-bottom:2px;">Pemohon</div>${i.signature ? `<img src="${i.signature}" style="height:30px; width:60px; object-fit:contain; background:white; border-radius:4px; border:1px solid #e2e8f0;" title="Ttd Pengaju">` : `<div style="height:30px; width:60px; background:#f1f5f9; border-radius:4px; border:1px dashed #cbd5e1; display:flex; align-items:center; justify-content:center; color:#94a3b8; font-size:10px;">Kosong</div>`}</div>
          <div style="text-align:center;"><div style="font-size:9px;color:#64748b;font-weight:600;margin-bottom:2px;">Manager</div>${i.adminSignature && i.adminSignature.manager ? `<img src="${i.adminSignature.manager}" style="height:30px; width:60px; object-fit:contain; background:white; border-radius:4px; border:1px solid #e2e8f0;" title="Ttd Manager">` : `<div style="height:30px; width:60px; background:#f1f5f9; border-radius:4px; border:1px dashed #cbd5e1; display:flex; align-items:center; justify-content:center; color:#94a3b8; font-size:10px;">Kosong</div>`}</div>
          <div style="text-align:center;"><div style="font-size:9px;color:#64748b;font-weight:600;margin-bottom:2px;">Direktur</div>${i.adminSignature && i.adminSignature.direktur ? `<img src="${i.adminSignature.direktur}" style="height:30px; width:60px; object-fit:contain; background:white; border-radius:4px; border:1px solid #e2e8f0;" title="Ttd Direktur">` : `<div style="height:30px; width:60px; background:#f1f5f9; border-radius:4px; border:1px dashed #cbd5e1; display:flex; align-items:center; justify-content:center; color:#94a3b8; font-size:10px;">Kosong</div>`}</div>
        </div>
      </td>
      <td>
      ...
      <td>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
          ...
          <div style="display: flex; gap: 8px; flex-wrap: wrap; justify-content: center; margin-top:4px;">
            <div style="text-align:center;"><div style="font-size:9px;color:#64748b;font-weight:600;margin-bottom:2px;">Pemohon</div>${item.signature ? `<img src="${item.signature}" alt="TTD Pengaju" style="height: 35px; width: 60px; object-fit:contain; background: white; border: 1px solid var(--clr-border); border-radius: 4px; padding: 2px;" title="TTD Pengaju">` : `<div style="height:35px; width:60px; background:#f1f5f9; border-radius:4px; border:1px dashed #cbd5e1; display:flex; align-items:center; justify-content:center; color:#94a3b8; font-size:10px;">Kosong</div>`}</div>
            <div style="text-align:center;"><div style="font-size:9px;color:#64748b;font-weight:600;margin-bottom:2px;">Manager</div>${item.adminSignature && item.adminSignature.manager ? `<img src="${item.adminSignature.manager}" alt="TTD Manager" style="height: 35px; width: 60px; object-fit:contain; background: white; border: 1px solid var(--clr-border); border-radius: 4px; padding: 2px;" title="TTD Manager">` : `<div style="height:35px; width:60px; background:#f1f5f9; border-radius:4px; border:1px dashed #cbd5e1; display:flex; align-items:center; justify-content:center; color:#94a3b8; font-size:10px;">Kosong</div>`}</div>
            <div style="text-align:center;"><div style="font-size:9px;color:#64748b;font-weight:600;margin-bottom:2px;">Direktur</div>${item.adminSignature && item.adminSignature.direktur ? `<img src="${item.adminSignature.direktur}" alt="TTD Direktur" style="height: 35px; width: 60px; object-fit:contain; background: white; border: 1px solid var(--clr-border); border-radius: 4px; padding: 2px;" title="TTD Direktur">` : `<div style="height:35px; width:60px; background:#f1f5f9; border-radius:4px; border:1px dashed #cbd5e1; display:flex; align-items:center; justify-content:center; color:#94a3b8; font-size:10px;">Kosong</div>`}</div>
          </div>
        </div>
      </td>
...
// Auto-inject data-label for mobile responsive tables
